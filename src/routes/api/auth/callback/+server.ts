...
export const GET: RequestHandler = async ({ url, cookies, fetch }) => {
  ...
  const storedChallengeCodeVerifier = cookies.get('spotify_auth_challenge_code_verifier')
  ...
  const response = await fetch('https://accounts.spotify.com/api/token', {
    ...
    body: new URLSearchParams({
      ...
      code_verifier: storedChallengeCodeVerifier || '',
  ...
  cookies.delete('spotify_auth_challenge_code_verifier')
